const countDownDate = new Date("January 1,2022 21:0:0").getTime(); // Change later
...
function toggleCollapseSection() {
    var collapse = document.getElementById("collapseSection");
    ...
    if (collapse.style.display === "none") {
      ...
      btnText.innerHTML = "View more photo"; 
    } else {
      collapse.style.display = "none";
      btnText.innerHTML = "View less photo"; 
    }
  }
